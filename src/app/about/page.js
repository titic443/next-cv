  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-scroll">
        {/* Text container */}
        <div className="  px-4 gap-24 flex flex-col sm:px-12 lg:px-20 xl:px-48 xl:text-xl md:gap-32 lg:gap-48 zl:gap-64">
          {/* Biography */}
          <div className="flex flex-col gap-12 justify-center">
            <h1 className="font-bold text-2xl">BIOGRAPHY</h1>
            <p className=" italic">
              exit: This prop defines the animation properties for when the
              component is removed from the DOM, typically due to a change in
              the parent component or route transition. It works similarly to
              animate, defining CSS properties and their target values. When the
              component is about to be removed, it will animate from its current
              state to the state defined in the exit prop before being
              unmounted.
            </p>
            <span>
              exit: This prop defines the animation properties for when the
            ...
            <div className="flex justify-between">
              ...
              <div className="w-1/6 ">
                ...
                <div className="w-1 h-full bg-gray-500 rounded relative">
                  {/* CIRCLE */}
                  <div className="absolute w-5 h-5 rounded-full ring-red-400  top-0 left-0 bg-white "></div>
                </div>
              </div>
              {/* RIGHT */}
